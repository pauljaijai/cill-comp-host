    ...
    >
      <div class=" relative w-full h-full font-wenkai tracking-widest">
        ...
        >
          ...
          >
            <div class="text-sm text-white text-right p-3">
          ...
          >
            <div class="text text-base text-center">
              繁星想念夜空的擁抱
              <br><br>
              人們想念炫麗的煙花
              <br><br>
          ...
          <div
            ...
            class=" absolute right-0 top-0 w-1/3 h-full flex-center "
          >
            <div class="text text-xl text-center ml-10">
              看<br>啥<br>？
            </div>
          </div>

          <div
            v-if="isTarget('photography-ears-of-rice')"
            class=" absolute right-1 bottom-1 "
          >
            <div class="text text-2xl !px-4">
              麥穗
            </div>
          </div>
          ...
          >
            <div class=" text-white text-center leading-10">
              在無月的夜
              <br>
              悄悄等待
              <br><br>
